...
@section('services-view-active', 'active')
@section('page-title', 'Services | View')
@section('content')
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card card-primary">
        ...
        <div class="card-body">
          <table id="service-records" class="table table-bordered table-hover table-responsive">
            <thead>
              <tr>
                <th>#</th>
                <th>Title</th>
              ...
              @foreach($records as $record)
                <tr id="tableRecord-{{$record->id}}">
                  ...
                  <td>
                      <a 
                        href="{{route('admins.service.edit',$record->id)}}" 
                        title="Edit" 
                        ...
                        <a 
                          ...
                          onclick="injectModalData('{{$record->id}}', '{{route('admins.service.trash')}}', 'confirm-password-form', 'POST')"
                        >
