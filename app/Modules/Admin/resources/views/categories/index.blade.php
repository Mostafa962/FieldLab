...
@section('categories-view-active', 'active')
@section('page-title', 'Categories | View')
@section('content')
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card card-primary">
        ...
        <div class="card-body">
          <table id="category-records" class="table table-bordered table-hover table-responsive">
            <thead>
              <tr>
                <th>#</th>
                <th>Name</th>
              ...
              @foreach($records as $record)
                <tr id="tableRecord-{{$record->id}}">
                  ...
                  <td>
                      <a 
                        href="{{route('admins.category.edit',$record->id)}}" 
                        title="Edit" 
                        ...
                        <a 
                          ...
                          onclick="injectModalData('{{$record->id}}', '{{route('admins.category.trash')}}', 'confirm-password-form', 'POST')"
                        >
